...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-01-2023 a las 02:51:02
...
CREATE TABLE `articulo` (
  ...
  `descripcion` varchar(256) COLLATE utf8_bin DEFAULT NULL,
...
--
DELIMITER $$
CREATE TRIGGER `tr_updateStockVenta` AFTER INSERT ON `detalle_venta` FOR EACH ROW BEGIN
    UPDATE articulo SET stock=stock-NEW.cantidad
WHERE articulo.idarticulo=NEW.idarticulo;
END
$$
...
(1, 'Carlos Mendieta', 'DNI', '9543356', 'Calle Loa #567', '6549832', 'carlitos@gmail.com', 'Administrador', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '1671663103.png', 1);
...
--
ALTER TABLE `usuario_permiso`
  MODIFY `idusuario_permiso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
