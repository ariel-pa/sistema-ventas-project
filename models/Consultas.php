...
class Consultas{
    ...
    public function comprasUltimos_10dias(){
        $sql = "SELECT CONCAT(DAY(fecha_hora),'-',DATE_FORMAT(fecha_hora, '%M')) as fecha, SUM(total_compra) as total FROM ingreso GROUP by fecha_hora ORDER by fecha_hora DESC limit 0,10";
